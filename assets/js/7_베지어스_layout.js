document.addEventListener("DOMContentLoaded", () => {
    const isRoot = window.location.pathname.endsWith("7_베지어스_index.html") || window.location.pathname.endsWith("/");
    ...
    <nav class="navbar">
        <div class="navbar_container">
            ...
            <ul class="navbar_menu">
                ...
                <li><a href="${pathPrefix}/pages/recipe/7_베지어스_recipe_main.html" class="nav_item">RECIPE</a></li>
                <li><a href="${pathPrefix}/pages/map/7_베지어스_map.html" class="nav_item">MAP</a></li>
                <li><a href="${pathPrefix}/pages/community/7_베지어스_community.html" class="nav_item">COMMUNITY</a></li>
                <li><a href="${pathPrefix}/pages/mypage/7_베지어스_mypage.html" class="nav_item">MYPAGE</a></li>
            </ul>
    ...
    if (settingLink) {
        settingLink.addEventListener('click', function (e) {
            ...
            if (!currentUser) {
                ...
                if (confirm("로그인 페이지로 이동하시겠습니까?")) {
                    window.location.href = isRoot ? "./pages/login/7_베지어스_login.html" : "../../pages/login/7_베지어스_login.html";
                }
            }
        });
    }
